...
export const AccountProfileDetails = (props) => {
  ...
  return (
    <form autoComplete="off" noValidate {...props} >
      <Card>
        <CardHeader subheader="Edit or save your information" title="Profile"
        />
        <Divider />
        <CardContent>
          <Grid container spacing={3} >
            ...
            <Grid item md={6} xs={12} >
              <TextField fullWidth helperText="Please specify the first name" label="First name" name="firstName" onChange={handleChange} required value={values.firstName} variant="outlined" />
            </Grid>
